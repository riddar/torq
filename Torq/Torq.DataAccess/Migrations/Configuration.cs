	...
	internal sealed class Configuration : DbMigrationsConfiguration<Context.TorqDBContext>
    {
        ...
        protected override void Seed(Context.TorqDBContext context)
        {
			...
			context.Employees.AddOrUpdate(e => e.Id,
				new Employee { Id=1, FirstName="Anders", LastName="And", IsOnline=true, RoleId=new Role { Id=1 } },
				new Employee { Id=2, FirstName="Kalle", LastName="Anka", IsOnline=true, RoleId=new Role { Id=1 } },
				new Employee { Id=3, FirstName="Donald", LastName="Duck", IsOnline=true, RoleId = new Role { Id = 2 } },
				new Employee { Id=4, FirstName="Akku", LastName="Anka", IsOnline=false, RoleId = new Role { Id = 1 } }
			);
